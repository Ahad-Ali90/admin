...
<x-admin.layouts.app>
  ...
  <div class="container-fluid py-4">
    <div class="row mb-4">
      <div class="col">
        <h1 class="h3 mb-0">Edit Terms and Conditions</h1>
        <p class="text-muted mb-0">Update existing terms and conditions</p>
      </div>
      <div class="col-auto">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-4">
              ...
              <select class="form-select @error('type') is-invalid @enderror" 
                ...
                <option value="customer" {{ old('type', $term->type) === 'customer' ? 'selected' : '' }}>Customer</option>
                <option value="company" {{ old('type', $term->type) === 'company' ? 'selected' : '' }}>Company</option>
              </select>
              @error('type')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-12">
              ...
              <textarea class="form-control @error('content') is-invalid @enderror" 
                        ...
                        required>{{ old('content', $term->content) }}</textarea>
              @error('content')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-md-6">
              ...
              <input type="number" 
                     ...
                     id="display_order" 
                     name="display_order" 
                     value="{{ old('display_order', $term->display_order) }}" 
                     min="0"
                     placeholder="0">
              @error('display_order')
                <div class="invalid-feedback">{{ $message }}</div>
        ...
        <div class="card-footer bg-transparent border-top">
          <div class="d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-primary">
              <i class="bi bi-check-lg me-1"></i>Update Term
            </button>
          </div>
        </div>
      </div>
